...
FswConfig default_config() {
    ...
    config.max_tvc_rad = 0.10471975511965977;
    config.max_fin_rad = 0.24434609527920614;
    config.control_kp = 0.75;
    config.control_kd = 0.18;
    config.max_voter_sample_skew_s = 0.01;
    config.acceleration_disagreement_m_s2 = 0.5;
    config.gyro_disagreement_rad_s = 0.01;
    config.magnetic_disagreement = 0.15;
    ...
    config.accelerometer_process_sigma_m_s2 = 0.08;
    config.gyro_process_sigma_rad_s = 0.0015;
    config.barometer_sigma_m = 1.5;
    config.gnss_altitude_sigma_m = 2.5;
    config.gnss_velocity_sigma_m_s = 0.15;
    ...
    config.launch_acceleration_threshold_m_s2 = 2.0;
    config.launch_persistence_s = 0.05;
    config.burnout_acceleration_threshold_m_s2 = 2.0;
    config.burnout_persistence_s = 0.05;
    config.apogee_min_altitude_m = 100.0;
    config.apogee_descent_velocity_m_s = -0.5;
    config.apogee_persistence_s = 0.20;
    config.landing_altitude_m = 2.0;
    config.landing_speed_m_s = 15.0;
    config.landing_persistence_s = 1.0;
    config.aero_reference_dynamic_pressure_pa = 35000.0;
    config.aero_high_q_authority_scale = 0.65;
    config.orbit_target_altitude_m = 200000.0;
    config.orbit_altitude_tolerance_m = 10000.0;
    config.orbit_cutoff_speed_margin_m_s = 10.0;
    config.orbit_radial_velocity_tolerance_m_s = 5.0;
    config.circularization_max_burn_s = 120.0;
    config.payload_deploy_delay_s = 10.0;
