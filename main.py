"""Realtime simplified rocket combustion chamber simulation.
...
def main() -> None:
    if os.environ.get("ASTARA_ENGINE_BENCH") != "1":
        from astara.ui import show_workbench

        if show_workbench(RealtimeSimulationApp):
            return
