...
def load_vehicle_definition(
    ...
    require_schema_version(vehicle, VEHICLE_SCHEMA_VERSION, vehicle_path)
...
def evidence_documents(
    ...
    require_schema_version(scenario_document, SCENARIO_SCHEMA_VERSION)
    reference = scenario_document["vehicle_definition"]
